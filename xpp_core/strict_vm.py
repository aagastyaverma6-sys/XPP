...
_cache = {}
_stats = {"hits": 0, "miss": 0, "compile_ms": 0.0}

def xitr_run(src: str, strict_ast: bool=False, cache_key=None, argv=None):
...
def clear_cache():
    _cache.clear()
    _stats.update(hits=0, miss=0, compile_ms=0.0)
